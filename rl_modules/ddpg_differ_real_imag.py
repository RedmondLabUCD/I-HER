...
class ddpg_differ_real_imag:
    ...
    def learn(self):
        ...
        """
        print('beginning differ_real_imag learning')
        ...
        for epoch in range(self.args.n_epochs):
            ...
            if MPI.COMM_WORLD.Get_rank() == 0:
                ...
                torch.save([self.o_norm.mean, self.o_norm.std, self.g_norm.mean, self.g_norm.std, self.actor_network.state_dict()], \
                            self.model_path + '/model23dynamics{}.pt'.format(epoch))
    ...
    def update_dynamics(self, epoch, batch_size=512, steps=2e4, scale_initial=5):
        ...
        if MPI.COMM_WORLD.Get_rank() == 0:
            ...
            torch.save(model_state, '23EnsembleOf{}_epoch{}.tar'.format(len(self.ensemble_models), epoch))
